"""
Feature Engineering: baut aus den Rohdaten (Fixtures, Match-Stats, Ranking-Ratings)
...
WM-2026-Teams werden Formkurve/Stats/Ranking NUR aus Daten berechnet, die vor dem
...
def load_ranking_ratings() -> dict:
    """Liest die Ranking-CSV ein: {year: {country_name: rating}}"""
    ranking_by_year = {}
...
def get_ranking(ranking_by_year: dict, fifa_name: str, year: int):
    """Holt das Ranking-Rating für ein Team im gegebenen Jahr, sonst das letzte
